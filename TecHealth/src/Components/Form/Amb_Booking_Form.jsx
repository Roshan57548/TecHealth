  ...
  return (
    <div className="popup">
      <div className="popup-content">
        <div className="popup-content-cl-btn"><CloseIcon className="form_close_icon" onClick={handleClose} /> </div>
                ...
                <Form.Group as={Col} controlId="formGridEmail">
                  ...
                  <Row >
                    <Form.Group className="mb-3"  controlId="formGridtext">
                      ...
                      <Form.Control
                        name="AmbulanceType"
                        value={user.values.AmbulanceType}
                        onChange={user.handleChange}
                        // type="email"
                    ...
                    <Form.Group className="mb-3"  controlId="formGridtext">
                      ...
                      <Form.Control
                        ...
                        rows={1}
                      />
                      {user.touched.PickupLocation && user.errors.PickupLocation && (
                        <p className="error-part">{user.errors.PickupLocation}</p>
                      )}
                    </Form.Group>
                  </Row>
                  <Row>
                  <Form.Group className="mb-3" controlId="formGridtext">
                    ...
                    <Form.Control
                      ...
                      rows={1}
                    />
                     {user.touched.DropLocation && user.errors.DropLocation && (
                        <p className="error-part">{user.errors.DropLocation}</p>
                      )}
                  </Form.Group>
                  </Row>
