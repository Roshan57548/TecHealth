      ...
      <div className='col-lg-6 service-image-body'>
          <div className="service-image-0">
            <div className="service-image-1">
              <img src="https://www.goaid.in/wp-content/uploads/2022/12/1297733538.png" className='service-imgg' alt="" />
            </div>
          </div>
      </div>
      <div className='col-lg-6 service-image-content'>
          <h1 className='service-main-heading'>{props.data.Heading} <span className='service-main-heading1'>{props.data.Heading1}</span></h1>
